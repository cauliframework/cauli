...
namespace :test do
  ...
  task ios: :prepare do
    run_tests('Cauliframework', 'iphonesimulator', 'iPhone 6', '12.4')
    run_tests('Cauliframework', 'iphonesimulator', 'iPhone 7', '13.7')
    run_tests('Cauliframework', 'iphonesimulator', 'iPhone 8', '14.4')
  end

  desc 'Build the Cauli iOS Example Application'
  task ios_example: :prepare do
    run_build('cauli-ios-example', 'iphonesimulator', 'iPhone 8', '14.4')
  end
end
...
def run_build(scheme, sdk, device = 'iPhone 8', os = '14.4')
...
def run_tests(scheme, sdk, device = 'iPhone 8', os = '14.4')
